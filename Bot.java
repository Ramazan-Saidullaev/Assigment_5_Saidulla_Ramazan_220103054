...
public class Bot extends TelegramLongPollingBot {
    ...
    public String getBotUsername() {
        return "srssrssrs05"; // Метод, который возвращает username бота.
    }

    @Override
    public String getBotToken() {
        return "6453272615:AAHOn-NEPX0TXASKFAHkgisVxSrd7qfWtJc"; // Метод, который возвращает token бота.
    }
